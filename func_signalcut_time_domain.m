function [x_slice_w, y_slice_w, z_slice_w] = func_signalcut_time_domain (path, filename, coarseInterval, numVib)
%% Parameter Setting
...
% figure()
% findpeaks(convol,rate,'MinPeakDistance', 1.5, 'MinPeakHeight', threshold)
