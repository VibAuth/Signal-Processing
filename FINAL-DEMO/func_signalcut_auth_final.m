function [check, xSpec_wide, ySpec_wide, zSpec_wide] = func_signalcut_auth_final (path, filename, coarseInterval, numVib)
%% Parameter Setting
...
%% Save each weight
xWeight_all = (xWeight1);
yWeight_all = (yWeight1);
zWeight_all = (zWeight1);
